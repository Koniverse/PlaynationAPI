...
import PointAdjustmentHistory from '@src/models/PointAdjustmentHistory';
...
SequelizeServiceImpl.addSync(PointAdjustmentHistory.sync.bind(PointAdjustmentHistory));
...
export * from '@src/models/PointAdjustmentHistory';
